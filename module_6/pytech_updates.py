...
result = students.update_one({"student_id": "1007"}, {"$set": {"last_name": "Judge II"}})

# find the updated student document 
aaron = students.find_one({"student_id": "1007"})

# display message
print("\n  -- DISPLAYING STUDENT DOCUMENT 1007 --")

# output the updated document to the terminal window
print("  Student ID: " + aaron["student_id"] + "\n  First Name: " + aaron["first_name"] + "\n  Last Name: " + aaron["last_name"] + "\n")
